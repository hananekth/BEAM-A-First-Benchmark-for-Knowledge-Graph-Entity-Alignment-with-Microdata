...
def test_webapp_presets_use_valid_wikidata_ids():
    ...
    assert testclass["matching_mode"] == "property"
    ...
    assert testclass_large["matching_mode"] == "property"
    ...
    assert testclass_label["matching_mode"] == "property"
    ...
    assert testclass_wikidata_url["matching_mode"] == "sameas"
    ...
    assert testclass_wikidata_sameas["matching_mode"] == "sameas"
    ...
    assert college_phone["matching_mode"] == "property"
    ...
    assert city_link["matching_mode"] == "sameas"
