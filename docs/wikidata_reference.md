...
| Language matching by label | `Q34772` (language) | `rdfs:label` | Label-based matching (not a Wikidata property item). |
| Country matching by ISO-2 | `Q6256` (country) | `P297` (ISO 3166-1 alpha-2 code) | Stable identifier for countries. |
| City matching by Wikidata URL (`sameAs`) | `Q486972` | N/A (`wdc_value_is_wikidata=true`) | City preset uses direct Wikidata URLs from WDC values. |

Primary sources:
- https://www.wikidata.org/wiki/Q11424
- https://www.wikidata.org/wiki/Property:P2704
- https://www.wikidata.org/wiki/Q34772
